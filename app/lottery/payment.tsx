      ...
      <View style={styles.container}>
        ...
        >
          ...
          <Text style={styles.successSubtitle}>
            Your lottery ticket and insurance coverage are now active
          </Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.summarySection}>
          ...
          <View style={styles.summaryCard}>
            ...
            <View style={styles.lotterySection}>
              <Text style={styles.lotteryTitle}>Lottery Numbers</Text>
              ...
              {selectedInsuranceData.map((insurance, index) => (
                <View key={insurance.id} style={styles.insuranceItem}>
                  <View style={styles.insuranceInfo}>
                    ...
                    <Text style={styles.insuranceCoverage}>Coverage: {insurance.coverage}</Text>
                  </View>
            ...
            <View style={styles.coverageRow}>
              ...
              <Text style={styles.coverageText}>
                Total Insurance Coverage: ${parseInt(totalCoverage).toLocaleString()}
              </Text>
            </View>
          </View>
        </View>
            ...
            {paymentStatus === 'pending' ? (
              <>
                ...
                <Text style={styles.qrInstructions}>
                  Scan this QR code with your banking app or digital wallet to complete the payment
                </Text>
              </>
            ) : (
          ...
          <View style={styles.methodsSection}>
            ...
            <View style={styles.methodsContainer}>
              <View style={styles.methodItem}>
                <Text style={styles.methodText}>• Mobile Banking Apps</Text>
              </View>
              <View style={styles.methodItem}>
                <Text style={styles.methodText}>• Digital Wallets (PayPal, etc.)</Text>
              </View>
              <View style={styles.methodItem}>
                <Text style={styles.methodText}>• Cryptocurrency Wallets</Text>
              </View>
              <View style={styles.methodItem}>
                <Text style={styles.methodText}>• QR Payment Services</Text>
              </View>
            </View>
          </View>
        )}
        ...
        {paymentStatus === 'pending' && (
          <TouchableOpacity style={styles.demoButton} onPress={simulatePayment}>
            ...
            >
              <Text style={styles.demoButtonText}>Simulate Payment (Demo)</Text>
            </LinearGradient>
          </TouchableOpacity>
        )}
      </ScrollView>
