...
export default function InsuranceSelectionScreen() {
  ...
  const getTotalCoverage = () => {
    return selectedInsurance.reduce((total, id) => {
      ...
      // Extract only digits from the coverage string
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>เลือกประกัน</Text>
          <View style={styles.placeholder} />
        </View>
        <Text style={styles.headerSubtitle}>
          เลือกความคุ้มครองสำหรับสลากของคุณ
        </Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.numbersSection}>
          <Text style={styles.sectionTitle}>หมายเลขสลากของคุณ</Text>
        ...
        <View style={styles.insuranceSection}>
          <Text style={styles.sectionTitle}>ตัวเลือกประกัน</Text>
                ...
                <View style={styles.cardContent}>
                  ...
                  <View style={styles.insuranceInfo}>
                    ...
                    <View style={styles.coverageRow}>
                      <Text style={styles.coverageLabel}>ความคุ้มครอง:</Text>
                    ...
                    <View style={styles.benefitsContainer}>
                      ...
                      {insurance.benefits.length > 3 && (
                        <Text style={styles.moreBenefits}>+{insurance.benefits.length - 3} รายการเพิ่มเติม</Text>
                      )}
                    </View>
                  </View>
                </View>
      ...
      <View style={styles.footer}>
        <View style={styles.summaryContainer}>
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>จำนวนสลาก:</Text>
            <Text style={styles.summaryValue}>{selectedNumbers.length} ใบ</Text>
          </View>
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>ประเภทประกัน:</Text>
          ...
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>ราคารวม <Text style={{fontSize:12, color:'#6b7280'}}>(รวมประกัน + ค่าฝากสลาก)</Text></Text>
            <Text style={styles.summaryValue}>฿{getTotalPrice()}</Text>
          </View>
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>ความคุ้มครองรวม:</Text>
